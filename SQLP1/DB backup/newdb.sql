...
--
-- Temporary view structure for view `emp_full_data`
--

DROP TABLE IF EXISTS `emp_full_data`;
/*!50001 DROP VIEW IF EXISTS `emp_full_data`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `emp_full_data` AS SELECT 
 1 AS `Emp Name`,
 1 AS `dname`*/;
SET character_set_client = @saved_cs_client;
...
INSERT INTO `table1` VALUES (12,'abc','2022-09-09'),(13,'ccc',NULL);
...
/*!50001 VIEW `emp_data` AS select concat(`employee`.`Fname`,' ',`employee`.`Lname`) AS `Emp Name`,`employee`.`DNO` AS `dno` from `employee` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `emp_full_data`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `emp_full_data` AS select concat(`employee`.`Fname`,' ',`employee`.`Lname`) AS `Emp Name`,`departments`.`Dname` AS `dname` from (`employee` join `departments`) where (`employee`.`DNO` = `departments`.`Dnum`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2022-09-26 11:56:14
